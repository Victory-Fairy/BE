...
public interface DiaryModel {
    ...
    class DiaryDto {
        ...
        public DiaryDto(Long id, Long teamId, String content, LocalDateTime matchAt, MatchEnum.ResultType resultType,
                String shortName, String fullName, MatchEnum.MatchStatus matchStatus, Long awayTeamId,
                String awayTeamName, Short awayScore, Long homeTeamId, String homeTeamName, Short homeScore,
                LocalDateTime createdAt) {
            this.id = id;
            this.teamId = teamId;
