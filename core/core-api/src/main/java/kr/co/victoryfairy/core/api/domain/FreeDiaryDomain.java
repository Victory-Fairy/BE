...
public interface FreeDiaryDomain {
    ...
    record WriteRequest(
            @Schema(description = "경기 상태", implementation = MatchEnum.MatchStatus.class, requiredMode = Schema.RequiredMode.REQUIRED)
            MatchEnum.MatchStatus matchStatus,

            @Schema(description = "홈팀 이름", requiredMode = Schema.RequiredMode.REQUIRED)
            String homeTeamName,

            @Schema(description = "어웨이팀 이름", requiredMode = Schema.RequiredMode.REQUIRED)
            String awayTeamName,

            @Schema(description = "홈팀 점수")
            Short homeScore,

            @Schema(description = "어웨이팀 점수")
            Short awayScore,

            @Schema(description = "경기장 이름")
            String stadiumName,

            @Schema(description = "경기 일시", requiredMode = Schema.RequiredMode.REQUIRED)
            LocalDateTime matchAt,

            @Schema(description = "응원팀 이름")
            String teamName,
            ...
            DiaryEnum.WeatherType weather,

            @Schema(description = "내용")
            String content,

            @Schema(description = "좌석 후기")
            String seatReview,

            @Schema(description = "업로드 file id 리스트")
    ...
    record PartnerDto(
            @Schema(description = "함께한 사람 이름")
            String name,

            @Schema(description = "함께한 사람의 응원팀 ID")
            Long teamId
    ) {}
