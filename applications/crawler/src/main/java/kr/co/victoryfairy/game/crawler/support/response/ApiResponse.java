package kr.co.victoryfairy.game.crawler.support.response;

import kr.co.victoryfairy.game.crawler.support.response.error.ErrorMessage;
import kr.co.victoryfairy.game.crawler.support.response.error.ErrorType;
