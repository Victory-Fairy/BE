package kr.co.victoryfairy.web.response;
...
public interface MessageEnum {
    ...
    enum Common implements EnumDescriptor {
        ...
        REQUEST_PARAMETER("파라미터를 확인해주세요.", "Parameter is null"), REQUEST("요청이 완료되었습니다.", "Request completed."),
        REQUEST_FAIL("요청이 실패 하였습니다.", "Request failed."), MODIFY("수정이 완료되었습니다.", "Modification is complete."),
        SAVE("등록이 완료되었습니다.", "Registration is complete."), UPDATE("수정이 완료되었습니다.", "Update is complete."),
        DELETE("삭제가 완료되었습니다.", "Deletion is complete."), APPROVE("승인이 완료되었습니다.", "Approval completed."),
    ...
    enum Auth implements EnumDescriptor {
        ...
        FAIL_LOGIN("로그인에 실패하였습니다.", "Login failed."), FAIL_CUTOFF("차단된 회원입니다.", "blocked member."),
        ...
        ILLEGAL_REQUEST("잘못된 request 입니다.", "Illegal request."), ILLEGAL_CODE("잘못된 code 입니다.", "Illegal code,"),
        ILLEGAL_STATUS("잘못된 state 입니다.", "Illegal state."), FAIL_SNS("SNS 로그인에 실패했습니다.", "failed sns login.");
    ...
    enum CheckNick implements EnumDescriptor {
        ...
        AVAILABLE("사용 가능한 닉네임입니다.", "Available nickname."), DUPLICATE("중복된 닉네임입니다.", "Duplicated nickname."),;
    ...
    enum File implements EnumDescriptor {
        ...
        UPLOAD("업로드가 완료되었습니다.", "Upload completed."), FAIL_UPLOAD("업로드가 실패하였습니다.", "Upload failed."),
        FAIL_UPLOAD_FORMAT("지정된 형식이 아닙니다.", "Not in specified format."), FAIL_RESIZE("리사이즈에 실패했습니다.", "Fail resize"),
